...
def Steady_State(guesses):
    ...
    print 'r diffs', get_r(X1, K1_d,p_c1)-get_r(X2, K2_d,p_c1), get_r(X1, K1_d,p_c1)-r
    print 'r1s: ', get_r(X1, K1_d,p_c1), get_r(X1,K_s*(X1/(X1+X2)),p_c1)
    ...
    #error1 = r_new - r
    #error2 = w_new - w
    error1 = K1_d+K2_d-K_s
    error2 = L1_d+L2_d-L_s 
